...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_STOP "G27P1"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
...
#define CUSTOM_USER_MENUS
  ...
  #define CUSTOM_USER_MENU_TITLE "Scripts"
  //#define USER_SCRIPT_DONE "M117 User Script Done"
  #define USER_SCRIPT_AUDIBLE_FEEDBACK
  #define USER_SCRIPT_RETURN  // Return to status screen after a script

  #define USER_DESC_1 "Normal Mode"
  #define USER_GCODE_1 "M203 X500 Y500 Z26\nM500"

  #define USER_DESC_2 "Silent Mode"
  #define USER_GCODE_2 "M203 X99 Y99 Z2\nM500"
